...
import { KARUP_FINAL_CTA } from "@/data/sign-types/karup-letter"
import { SITE_CONTACT } from "@/data/site-contact"

export function FinalCtaKarup() {
  return (
    <section id="final-cta-karup" aria-labelledby="final-cta-karup-heading" className="bg-secondary">
      <div className="mx-auto max-w-content px-4 py-14 md:px-6 md:py-24">
        <div className="mx-auto max-w-3xl text-center">
          <p className="text-sm font-bold tracking-widest text-accent">{KARUP_FINAL_CTA.label}</p>
          <h2
            id="final-cta-karup-heading"
            className="mt-3 text-balance text-2xl font-black text-primary md:text-4xl"
          >
            {KARUP_FINAL_CTA.title}
          </h2>
          <p className="mt-4 text-pretty leading-relaxed text-muted-foreground">{KARUP_FINAL_CTA.subtitle}</p>
